...
class MainTest(TestBase):
    ...
    def get_sensors(self):
        netperf_graph = GraphGnuplot("msg size", "throughput", r"/tmp/throughput_1GB.pdf", r"/tmp/throughput_1GB.txt")
    ...
    def get_vms(self):
        virtualbox_e1000 = VirtualBox(r"e1000_1GB", "192.168.56.101", "192.168.56.1")
        virtualbox_virtio = VirtualBox(r"virtio_1GB", "192.168.56.102", "192.168.56.1")

        vmware_e1000 = VMware(r"/homes/bdaviv/Shared\ VMs/Ubuntu_Linux-e1000_1GB/Ubuntu\ Linux\ -\ e1000.vmx",
