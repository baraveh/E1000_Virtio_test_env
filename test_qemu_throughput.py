...
class QemuThroughputTest(TestBaseNetperf):
    ...
    def get_vms(self):
        qemu_e1000e = Qemu(disk_path=r"../vms/ubuntu.img",
                           guest_ip="10.10.0.43",
                           host_ip="10.10.0.44")
        ...
        qemu_virtio_drop_packets = QemuNG(disk_path=r"../vms/ubuntu.img",
                           guest_ip="10.10.0.43",
                           host_ip="10.10.0.44")
        ...
        qemu_e1000_arthur_nice = QemuE1000Max(disk_path=r"../vms/ubuntu.img",
                                         guest_ip="10.10.0.43",
                                         host_ip="10.10.0.44")
        qemu_e1000_arthur_nice.qemu_config["latency_itr"] = 0
        qemu_e1000_arthur_nice.is_io_thread_nice = True

        qemu_smart_itr = QemuE1000Max(disk_path=r"../vms/ubuntu.img",
                                      guest_ip="10.10.0.43",
                                      host_ip="10.10.0.44")
        ...
        qemu_smart_itr2 = QemuE1000Max(disk_path=r"../vms/ubuntu.img",
                                       guest_ip="10.10.0.43",
                                       host_ip="10.10.0.44")
        ...
        qemu_e1000_io_thread = QemuE1000Max(disk_path=r"../vms/ubuntu.img",
                                            guest_ip="10.10.0.43",
                                            host_ip="10.10.0.44")
        ...
        #
        # qemu_e1000_no_new_improv = QemuE1000Max(disk_path=r"../vms/ubuntu.img",
        #                                      guest_ip="10.10.0.43",
        #                                      host_ip="10.10.0.44")
        ...
        #
        # qemu_virtio_drop = QemuE1000Max(disk_path=r"../vms/ubuntu.img",
        #                                      guest_ip="10.10.0.43",
        #                                      host_ip="10.10.0.44")
        ...
        qemu_large_queue_itr6 = QemuLargeRing(disk_path=r"../vms/ubuntu.img",
                                         guest_ip="10.10.0.43",
                                         host_ip="10.10.0.44")
        ...
        # qemu_e1000_best_itr = QemuE1000Max(disk_path=r"../vms/ubuntu.img",
        #                                guest_ip="10.10.0.43",
        #                                host_ip="10.10.0.44")
        ...
        qemu_ng_max = QemuE1000NG(disk_path=r"../vms/ubuntu.img",
                                  guest_ip="10.10.0.43",
                                  host_ip="10.10.0.44")

        qemu_large_ring_ng = QemuLargeRingNG(disk_path=r"../vms/ubuntu.img",
                                             guest_ip="10.10.0.43",
                                             host_ip="10.10.0.44")

        qemu_ng_max_nocsum = QemuE1000NG(disk_path=r"../vms/ubuntu.img",
                                         guest_ip="10.10.0.43",
                                         host_ip="10.10.0.44")
        qemu_ng_max_nocsum.e1000_options["NG_no_checksum"] = "off"

        qemu_large_ring_ng_nocsum = QemuLargeRingNG(disk_path=r"../vms/ubuntu.img",
                                                    guest_ip="10.10.0.43",
                                                    host_ip="10.10.0.44")
        qemu_large_ring_ng_nocsum.e1000_options["NG_no_checksum"] = "off"
        qemu_virtio_nice = Qemu(disk_path=r"../vms/ubuntu.img",
                           guest_ip="10.10.0.43",
                           host_ip="10.10.0.44")
        ...
        qemu_large_ring_ng_tso_offload = QemuLargeRingNG(disk_path=r"../vms/ubuntu.img",
                                             guest_ip="10.10.0.43",
                                             host_ip="10.10.0.44")
