...
class QemuThroughputTest(TestBaseNetperf):
    ...
    def get_vms(self):
        ...
        qemu_large_queue_itr6 = QemuLargeRing(disk_path=r"../vms/ubuntu-20.img",
                                         guest_ip="10.10.0.43",
                                         host_ip="10.10.0.44")
        ...
        qemu_large_ring_ng_nocsum = QemuLargeRingNG(disk_path=r"../vms/ubuntu-20.img",
                                                    guest_ip="10.10.0.43",
                                                    host_ip="10.10.0.44")
        ...
        qemu_large_ring_ng_tso_offload = QemuLargeRingNG(disk_path=r"../vms/ubuntu-20.img",
                                             guest_ip="10.10.0.43",
                                             host_ip="10.10.0.44")
